...
st.set_page_config(page_title="小分け作業 優先順位判定指標作成ツール", layout="wide") # page_titleも変更

st.title("小分け作業 優先順位判定指標作成ツール") # タイトルを変更
...
- 「充足率」は「納品数」に対する「昨日残数」の割合（昨日残数÷納品数）で計算されます。
""")
